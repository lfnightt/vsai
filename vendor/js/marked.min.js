    ...
    var ye = (l, e) => {
        ...
        Re = (l, e, t, n) => {
            if (e && typeof e == "object" || typeof e == "function")
                for (let s of Te(e)) !we.call(l, s) && s !== t && H(l, s, {
                    get: () => e[s],
...
`),
                ...
                for (; n.length > 0;) {
                    ...
                    for (c = 0; c < n.length; c++)
                        if (this.rules.other.blockquoteStart.test(n[c])) a.push(n[c]), o = !0;
...
` ? t[1].slice(0, -1) : t[1];
        ...
        emStrong(e, t, n = "") {
            ...
            if (!(s[1] || s[2] || "") || !n || this.rules.inline.punctuation.exec(n)) {
                ...
                for (u.lastIndex = 0, t = t.slice(-1 * e.length + r);
                    (s = u.exec(t)) != null;) {
...
` + s.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = r.text) : t.push(s);
        ...
        inlineTokens(e, t = []) {
            ...
            if (this.tokens.links) {
                ...
                if (o.length > 0)
                    for (;
                        (s = this.tokenizer.rules.inline.reflinkSearch.exec(n)) != null;) o.includes(s[0].slice(s[0].lastIndexOf("[") + 1, -1)) && (n = n.slice(0, s.index) + "[" + "a".repeat(s[0].length - 2) + "]" + n.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex))
            }
            for (;
                (s = this.tokenizer.rules.inline.anyPunctuation.exec(n)) != null;) n = n.slice(0, s.index) + "++" + n.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);
            for (;
                (s = this.tokenizer.rules.inline.blockSkip.exec(n)) != null;) n = n.slice(0, s.index) + "[" + "a".repeat(s[0].length - 2) + "]" + n.slice(this.tokenizer.rules.inline.blockSkip.lastIndex);
            let i = !1,
                r = "";
            for (; e;) {
                i || (r = ""), i = !1;
                    ...
                    case "text":
                        {
                            ...
                            for (; s + 1 < e.length && e[s + 1].type === "text";) o = e[++s],
                            a += `
` + this.renderer.text(o);t ? n += this.renderer.paragraph({
                                type: "paragraph",
                                raw: a,
                                text: a,
                                tokens: [{
    ...
    var E = class {
        ...
        walkTokens(e, t) {
            ...
            for (let s of e) switch (n = n.concat(t.call(this, s)), s.type) {
                ...
                case "list":
                    {
                        let i = s;n = n.concat(this.walkTokens(i.items, t));
                        break
                    }
                default:
                    {
                        let i = s;this.defaults.extensions ?.childTokens ?.[i.type] ? this.defaults.extensions.childTokens[i.type].forEach(r => {
                            let o = i[r].flat(1 / 0);
